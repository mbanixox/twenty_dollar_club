...
#
#     PHX_SERVER=true bin/twenty_dollar_club start
#
...
if config_env() == :prod do
  ...
  config :twenty_dollar_club, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  config :twenty_dollar_club, TwentyDollarClubWeb.Endpoint,
    url: [host: host, port: 443, scheme: "https"],
    http: [
      # Bind to 0.0.0.0 on the port Fly.io expects (IPv4)
      ip: {0, 0, 0, 0},
      port: String.to_integer(System.get_env("PORT") || "4000")
    ],
    secret_key_base: secret_key_base,
    check_origin: ["//192.168.100.216", "//localhost"]
