defmodule TwentyDollarClub.MembershipsTest do
  ...
  describe "memberships" do
    ...
    test "update_membership/2 with valid data updates the membership" do
      membership = membership_fixture()
      update_attrs = %{role: "some updated role", generated_id: 43}
      ...
      assert membership.generated_id == 43
    end
